% Plots Errors for FE/EXP Values
...
plotTitle = ['FEA/EXP  Error in Mutual P1, Z = ' num2str(fea_z_value_selected)];
...
Z_ax2=griddata(plotValues(:,1),plotValues(:,2),plotValues(:,4),X,Y);
Z_ax3 = 100*rdivide((Z_ax - Z_ax2),Z_ax);
plotTitle = ['FEA/EXP  Error in Mutual P2, Z = ' num2str(fea_z_value_selected)];
...
Z_ax2=griddata(plotValues(:,1),plotValues(:,2),plotValues(:,4),X,Y);
Z_ax3 = 100*rdivide((Z_ax - Z_ax2),Z_ax);
plotTitle = ['FEA/EXP  Error in Coupling Both, Z = ' num2str(fea_z_value_selected)];
...
Z_ax2=griddata(plotValues(:,1),plotValues(:,2),plotValues(:,4),X,Y);
Z_ax3 = 100*rdivide((Z_ax - Z_ax2),Z_ax);
plotTitle = ['FEA/EXP  Error in Self S, Z = ' num2str(fea_z_value_selected)];
...
Z_ax2=griddata(plotValues(:,1),plotValues(:,2),plotValues(:,4),X,Y);
Z_ax3 = 100*rdivide((Z_ax - Z_ax2),Z_ax);
plotTitle = ['FEA/EXP  Error in Self P1, Z = ' num2str(fea_z_value_selected)];
...
Z_ax2=griddata(plotValues(:,1),plotValues(:,2),plotValues(:,4),X,Y);
Z_ax3 = 100*rdivide((Z_ax - Z_ax2),Z_ax);
plotTitle = ['FEA/EXP  Error in Self P2, Z = ' num2str(fea_z_value_selected)];
...
Z_ax2=griddata(plotValues(:,1),plotValues(:,2),plotValues(:,4),X,Y);
Z_ax3 = 100*rdivide((Z_ax - Z_ax2),Z_ax);
plotTitle = ['FEA/EXP  Error in Coupling P1, Z = ' num2str(fea_z_value_selected)];
...
Z_ax2=griddata(plotValues(:,1),plotValues(:,2),plotValues(:,4),X,Y);
Z_ax3 = 100*rdivide((Z_ax - Z_ax2),Z_ax);
plotTitle = ['FEA/EXP  Error in Coupling P2, Z = ' num2str(fea_z_value_selected)];
