...
results = exp_phase_src_iv;
plotValues = results(results(:,3)==z_value_selected,:);
plotTitle = ['Source I/V phase, Z = ' num2str(z_value_selected)];
Z_ax=griddata(plotValues(:,1),plotValues(:,2),plotValues(:,4),X,Y);
...
ax1.XGrid = 'on';
ax1.YGrid = 'on';
ax1.XTick = [-250 -225 -200 -175 -150 -125 -100 -75 -50 -25 0 25];
ax1.YTick = [0 10 20 30 40 50 60 70 80];

ax2.XGrid = 'on';
ax2.YGrid = 'on';
ax2.XTick = [-250 -225 -200 -175 -150 -125 -100 -75 -50 -25 0 25];
ax2.YTick = [0 10 20 30 40 50 60 70 80];

ax3.XGrid = 'on';
ax3.YGrid = 'on';
ax3.XTick = [-250 -225 -200 -175 -150 -125 -100 -75 -50 -25 0 25];
ax3.YTick = [0 10 20 30 40 50 60 70 80];

ax4.XGrid = 'on';
ax4.YGrid = 'on';
ax4.XTick = [-250 -225 -200 -175 -150 -125 -100 -75 -50 -25 0 25];
ax4.YTick = [0 10 20 30 40 50 60 70 80];

ax5.XGrid = 'on';
ax5.YGrid = 'on';
ax5.XTick = [-250 -225 -200 -175 -150 -125 -100 -75 -50 -25 0 25];
ax5.YTick = [0 10 20 30 40 50 60 70 80];

ax6.XGrid = 'on';
ax6.YGrid = 'on';
ax6.XTick = [-250 -225 -200 -175 -150 -125 -100 -75 -50 -25 0 25];
ax6.YTick = [0 10 20 30 40 50 60 70 80];

ax7.XGrid = 'on';
ax7.YGrid = 'on';
ax7.XTick = [-250 -225 -200 -175 -150 -125 -100 -75 -50 -25 0 25];
ax7.YTick = [0 10 20 30 40 50 60 70 80];

ax8.XGrid = 'on';
ax8.YGrid = 'on';
ax8.XTick = [-250 -225 -200 -175 -150 -125 -100 -75 -50 -25 0 25];
ax8.YTick = [0 10 20 30 40 50 60 70 80];
