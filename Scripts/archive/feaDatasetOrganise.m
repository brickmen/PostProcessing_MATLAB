%Extracts import 1 and applied symmetry assumption
...
for i = 1:1:length(fea_import.(struct_title))
   ...
   Ms1 =fea_import.(char(ux_fea_import_mid(4)))(i,4)+fea_import.(char(ux_fea_import_mid(6)))(i,4)+fea_import.(char(ux_fea_import_mid(5)))(i,4);
