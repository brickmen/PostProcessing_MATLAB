...
for i = 1:1:length(fea_mutual_p1)
   ...
   %
   k_p1 = fea_mutual_p1(i,4)/sqrt(fea_self_p1(i,4)*fea_self_s(i,4));
   k_p2 = fea_mutual_p2(i,4)/sqrt(fea_self_p2(i,4)*fea_self_s(i,4));
   ...
   k_b = (fea_mutual_p1(i,4)+fea_mutual_p2(i,4))/sqrt(fea_self_p(i,4)*fea_self_s(i,4));
   fea_coupling_both(i,:) = [fea_mutual_p2(i,1) fea_mutual_p2(i,2) fea_mutual_p2(i,3) k_b];
